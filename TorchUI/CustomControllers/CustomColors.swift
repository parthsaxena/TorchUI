...
struct CustomColors {
    ...
    static let torchDardRed = Color(red: 217/255, green: 45/255, blue: 32/255)
    static let torchDarkYellow = Color(red: 217/255, green: 119/255, blue: 6/255)
    static let torchOrange = Color(red: 2155/255, green: 91/255, blue: 36/255)
    ...
    static let lightGrayBackground = Color(red: 248/255, green: 250/255, blue: 250/255)
    static let lightGrayBorder = Color(red: 241/255, green: 243/255, blue: 243/255)
    static let darkGray = Color(red: 69/255, green: 81/255, blue: 84/255)
